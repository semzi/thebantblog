...
const Footer = () => {
    ...
    return (
        <div className=' bg-brand-primary text-white py-10 page-padding-x justify-between border-b border-brand-p3/70 items-center'>
            <p className='text-4xl mb-3 font-bold'>Join the waitlist!</p>
            <p className=' mb-7'>Get early access to the Game-Changing Platform, Where the Banter gets Better</p>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col md:flex-row gap-y-3  mb-5 items-center'>
                <input
                    ...
                    className='bg-white w-full px-4 py-2 rounded-l  text-neutral-500 outline-none focus:border-1  border-brand-p4'
                    required
                />
            ...
            <div className="flex items-center mb-30  max-w-lg gap-2">
